...
## Сдача лабораторной 4 (для ревьюера PR)

| Файл | Роль |
|------|------|
| `dungeon_before.py` | Игра **без** logging |
| `LR4.py` | Та же игра **с** logging в `game_log.txt` |
| `CHANGES.md` | 8+ точек логирования и diff |

Сравнение: `git diff msdt-4/dungeon_before.py msdt-4/LR4.py`
