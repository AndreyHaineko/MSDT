...
## Сдача лабораторной 1 (для ревьюера PR)

| Файл | Роль |
|------|------|
| `tennis_original.py` | **Исходный** код (Tennis Kata, до PEP8) |
| `LR1.py` | **Итог** рефакторинга |
| `REFACTORING.md` | Таблица из ≥5 применённых правил и ссылка на источник |

Сравнение изменений: `git diff msdt-1/tennis_original.py msdt-1/LR1.py`
